                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <div class="d-flex items-center">
                                ...
                                @if ($trash)
                                    <a href="{{ route('admin.catalogues.trash') }}" class="">
                                        <i class="las la-trash-alt btn btn-danger"></i>
                                    </a>
                                @endif
                            </div>
                            <a class="btn btn-primary" href="{{ route('admin.catalogues.create') }}">Create</a>
                        </div>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>{!! $item->parent_id
                                                ...
                                                : '<span class="badge bg-info">Dad</span>' !!}</td>
                                            <td>
                                                {!! $item->status === 'publish' 
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <form action="{{ route('admin.catalogues.delete', $item->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
