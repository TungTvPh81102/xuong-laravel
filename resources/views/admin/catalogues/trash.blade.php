                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($catalogue as $item)
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td>{{ $item->name }}</td>
                                            <td>{!! $item->parent_id ? '<span class="badge bg-primary">Child</span>' : '<span class="badge bg-info">Dad</span>' !!}</td>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a onclick="return confirm('Are you sure?')"
                                                        href="{{ route('admin.catalogues.restore', $item->id) }}"
                            ...
                            <a class="btn btn-info" href="{{ route('admin.catalogues.index') }}">Back to list</a>
                        </div>
                    </div>
                </div><!--end col-->
            </div><!--end row-->
