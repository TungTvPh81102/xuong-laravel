                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="checkout-form-list">
                                        ...
                                        <input value="{{ auth()->user()?->name }}" name="user_name" type="text"
                                            placeholder="" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="checkout-form-list">
                                        <label>Email</label>
                                        <input value="{{ auth()->user()?->email }}" name="user_email" type="email"
                                            placeholder="" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <table>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr class="order-total">
                                            <th>Order Total</th>
                                            <td><strong><span class="amount">{{ number_format($totalAmount) }}đ</span></strong>
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
